class DropShotDrill : Drill
{
    public DropShotDrill() : base(
        ...
        "- After the receive, the receiving player should respond with a controlled forehand drop shot. The objective is to softly place the ball just over the net, ideally landing it in the opponent's non-volley zone (the kitchen).\n" +
