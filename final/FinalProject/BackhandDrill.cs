class BackhandDrill:Drill{
    ...
    "- After the receive, the receiving player should respond with a controlled backhand shot. Focus on using proper footwork and racquet preparation.\n" +
    ...
    "- The serving player should then attempt to return the backhand shot with a soft volley or an aggressive shot, depending on the situation.\n" +
    "- Continue rallying back and forth, alternating between serving and receiving, with both players focusing on executing quality backhand shots and maintaining a consistent rally."
) {
}
